  ...
  return (
    <div className="w-full flex justify-center gap-5 md:gap-20 p-4 md:p-10  text-black ">
        ...
        <section className=' flex-col justify-center md:w-[40%] p-4 md:p-20 bg-gray-900  rounded-xl hover:bg-gray-800 duration-150 text-white' >
          ...
          <p>
            Email:  <a href="mailto:patwalayush2005@ayushpatwal.com">patwalayush2005@gmail.com</a>
          </p>
          <p>
            LinkedIn: <a href="https://www.linkedin.com/in/ayushpatwal/">ayushpatwal</a>
          </p>
          <p>
            GitHub:  <a href="https://github.com/ayushpatwal011">ayushpatwal2005</a>
          </p>
        </section>
    </div>
  )
